...
export default function Why() {
  ...
  const offerings = [
    ...
    {title: "Catered Playlists", description: "Description 6", icon: <ListVideo className="flex justify-self-center w-[60px] h-[60px] text-yellow-500"/>},
    {title: "Exclusive Quizzes", description: "Description 6", icon: <ClipboardCheck className="flex justify-self-center w-[60px] h-[60px] text-yellow-500"/>},
    {title: "Mentorship/Coaching", description: "Description 6", icon: <Handshake className="flex justify-self-center w-[60px] h-[60px] text-yellow-500"/>},
    {title: "Study Plans", description: "Description 6", icon: <Calendar className="flex justify-self-center w-[60px] h-[60px] text-yellow-500"/>},
    {title: "Relevant exam questions", description: "Description 6", icon: <Variable className="flex justify-self-center w-[60px] h-[60px] text-yellow-500"/>},
    {title: "Ranking and Benchmarking", description: "Description 6", icon: <Medal className="flex justify-self-center w-[60px] h-[60px] text-yellow-500"/>}
  ]
  return (
      ...
      <div>
        <div className="relative mx-auto space-y-5 mb-20">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-10 mx-40 gap-x-5">
            ...
            <div className="space-y-3 bg-secondary-color rounded-2xl py-10">
              {feature.icon}
